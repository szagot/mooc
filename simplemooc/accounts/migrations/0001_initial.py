# Generated by Django 2.2.3 on 2019-08-01 21:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=30, unique=True, validators=[django.core.validators.RegexValidator(re.compile('^[\\w.@+_-]+$'), 'O nome de usuário só pode conter letras, números ou @.+_-', 'invalid')], verbose_name='Nome de Usuário')),
